...
static esp_err_t qrcoderslt_handler(httpd_req_t *req){
  ...
  I2CSensors.beginTransmission(4);
  uint8_t buf[QRCodeResultSend.length()];
  QRCodeResult.getBytes(buf, QRCodeResultSend.length());
  I2CSensors.write(buf, QRCodeResultSend.length());
...
//  mylcd.print("Hello, my name is NG");
//  
//}
//
